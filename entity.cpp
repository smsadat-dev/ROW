...
void Entity::updateEntity(SDL_Renderer* entityRender, SDL_Rect* entityRect)
{
...
void Entity::renderEntity(SDL_Renderer*& entityRender, SDL_Rect* entityRect, EntityRGBA eRGBA)
{
    if(!entityRender)
    {
